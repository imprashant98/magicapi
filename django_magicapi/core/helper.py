...
class FileWriter:
    ...
    def write(self):
        ...
        if os.path.exists(self.target_path):
            ...
            if not first_line.startswith('# DJANGO_MAGICAPI_GENERATED') and not self.force:
                raise CommandError(
                    f"File {self.target_path} already exists and was not created by django-magicapi.\n"
            ...
            if self.subfolder in ('serializers', 'viewsets'):
                ...
                if not os.path.exists(init_path):
                    with open(init_path, 'w') as f_init:
                        f_init.write("# Auto-generated by django-magicapi\n")

        with open(self.target_path, 'w') as f:
            if not self.force and self._should_add_marker():
                f.write("# DJANGO_MAGICAPI_GENERATED\n")
            f.write(content)
        ...
        if self.component_type in ('serializers', 'viewsets') and self.subfolder:
            ...
            if not os.path.exists(init_path):
                with open(init_path, 'w') as f:
                    f.write("# Auto-generated by django-magicapi\n")
